			...
			<div class="row">
				 <div class="span4">
					<div class="well">
						...
						<form:form action="chinhsua" method="POST" modelAttribute="upbook">
							<div class="control-group">
							<div class="controls">
								<label class="control-label" for="inputidbook">Chọn sách</label>
								<form:select path="idbook">
									<c:forEach var="item" items="${ books }" varStatus="">
										<form:option value="${item.idbook}" label="${item.tensach}" />
									</c:forEach>
								</form:select>
							</div>
							<div class="controls">
							...
							<div class="controls">
								<button type="submit" class="btn block">Chỉnh sửa</button></div>
						</form:form>
							</div>
					</div>
				</div>
