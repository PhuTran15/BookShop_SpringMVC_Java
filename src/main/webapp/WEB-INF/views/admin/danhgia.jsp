			...
			<div class="container">
				...
				<div class="nav-collapse">
					<ul class="nav">
						...
						<li class="active"><a href="<c:url value="danhgia"/>">Đánh giá sách</a></li>
					</ul>
	...
	<div>
		<table class="table">
			...
			<tbody>
					...
					<c:forEach var="item" items="${ danhgia }" varStatus="index">
						<tr id="lienhe" >
							<td>${ item.idbook }</td>
							<td>${ item.noidung }</td>
							<td><a href="<c:url value="/xoadanhgia/${item.iddanhgia}" />">Xóa</a>					
						</tr>
					</c:forEach> 
			</tbody>
		</table>
