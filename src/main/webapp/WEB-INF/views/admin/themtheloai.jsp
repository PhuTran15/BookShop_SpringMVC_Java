...
<body>
	...
	<div class="navbar">
		...
		<div class="row">
			<div class="span4">
				<div class="well">
					<h5>Thêm sản thể loại mới</h5>
					<form:form action="themtheloai" method="POST"
						modelAttribute="addtheloai">
						<label class="control-label" for="inputTenSach">Nhập Tên
							Thể Loại</label>
						<div class="controls">
							<form:input class="span3" placeholder="Tên thể loại"
								path="theloai" />
						</div>
						<div class="controls">
							<button type="submit" class="btn block">Thêm thể loại</button>
						</div>
					</form:form>
				</div>
